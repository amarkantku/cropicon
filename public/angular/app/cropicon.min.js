...
angular.element(document).ready(function() {}), function(window, angular) {
    ...
    return {
        doLogin: function(params) {
            return console.log(params), $http.post(API_PATH + "users/login", {
                email: params.username,
                password: params.password
            }).success(function(data) {
                return console.log(data), AuthToken.setToken(data.token), data;
    ...
    return {
        ...
        setToken: function(token) {
            console.log(token), console.log("in AuthToken"), token ? $window.localStorage.setItem("token", token) : $window.localStorage.removeItem("token");
        },
